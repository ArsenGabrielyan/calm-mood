...
export default function NotFoundContent(){
     ...
     return (
          <div className="p-5 flex justify-center items-center flex-col min-h-screen space-y-3">
               ...
               <p className="font-heading text-3xl md:text-4xl lg:text-[42px] tracking-tight font-bold text-center">{t("title")}</p>
               <p className="text-base md:text-lg font-light text-center">{t("description")}</p>
               <Button asChild>
